...
/**Given an asynchronous function fn and a time t in milliseconds, return 
 * a new time limited version of the input function. fn takes arguments 
...
var timeLimit = function (fn, t) {
  return async function (...args) {
    let fnExec = fn(...args);
    let fnRej = new Promise((resolve, reject) => {
      setTimeout(() => {
